...
- Кастомный логотип/фотографию (`fastfetch/logo.png`)
- Оптимизированный конфигурационный файл (`fastfetch/config.jsonc`)
- Автоматический установщик для Linux

## 🖼️ Логотип

Логотип находится в файле: `fastfetch_Kwéebecs/fastfetch/logo.png`
...
- 🎨 Кастомный логотип из `fastfetch/logo.png`
...
С логотипом из `fastfetch/logo.png` вывод fastfetch будет выглядеть примерно так:
